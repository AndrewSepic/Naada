...
function create_sruti_box() {
  ...
  // Widget description
      ...
      function widget($args, $instance) {
              ...
              if(!$)
              {
                  ...
                  jq.onload=function(){
                      $(window).on('load',function() {
                          sruti.init('/wp-content/plugins/sruti-box/');
                      });
                  }
          ...
          <script type="text/javascript" src="/wp-content/plugins/sruti-box/sruti.min.js"></script>
...
// register widget
add_action('widgets_init', 'create_sruti_box');
?>
